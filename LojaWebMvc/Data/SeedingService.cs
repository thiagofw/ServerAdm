...
public class SeedingService
{
    ...
    {
        using (var _context = new VsproContext(
            ...
            Server srv1 = new Server(1, "Linux", "10.100.100.1", ServerStatus.Enabled);

            Login login1 = new Login(1, "Thiago", "123456", "tfcruz",  srv1);
            ...
            _context.Server.AddRange(srv1);

            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6);
            _context.Login.AddRange(login1);
